          ...
          <>
            {running && currentBlock === null ? (
              ...
              <div className="flex flex-col lg:p-16 p-6 2xl:p-20 space-y-10 2xl:space-y-14 ">
                ...
                Quickly and efficiently verify proofs from the <Link href={`https://www.availproject.org/`} className="text-[#3CBBF9] underline">Avail data availability layer</Link> right inside your browser. Give end users guarantees with cryptographic certainty that published data is both available and in its original form.
                </p>
                <p className="text-lg  font-ppmori  text-white !text-left lg:block text-opacity-80 ">
                While most users cannot, or do not wish to run full nodes on their own devices, light clients are small enough to download and run on smartphones and in this case even a browser without relying on a centralized RPC provider or someone else’s full node. This can put <i>decentralized verification</i> into the palms of every user’s hand.
