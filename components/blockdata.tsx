                ...
                <div>
                    <div className="flex flex-col items-end space-y-4">
                        <div className="flex flex-col ">
                            ...
                            <p className="text-green-500 font-thicccboibold text-3xl 2xl:text-4xl text-right">{latestBlock.hash.toString().slice(0, 6)}..</p>
                        </div>
                        <div className="flex flex-col ">
                            ...
                            <p className="text-green-500 font-thicccboibold text-3xl 2xl:text-4xl text-right">#{latestBlock.number}</p>
                        </div>
                        <div className="flex flex-col ">
                            ...
                            <p className="text-green-500 font-thicccboibold text-3xl 2xl:text-4xl text-right">{latestBlock.totalCellCount}</p>
                        </div>
                    </div>
