        ...
        <div className="flex flex-col w-full space-y-6 mx-6">
            <div className="flex flex-col space-y-2">
                ...
                <div className="md:hidden flex flex-col items-center justify-center py-8">
                    <Button variant={'outline'} className='text-white rounded-full border-opacity-70 bg-opacity-50 px-8 py-6 font-thicccboibold' >Start Running the LC</Button>
                </div>
            ...
            <div className="flex flex-row justify-between lg:mr-4 items-start ">
                <div className="flex flex-col items-start">
                    ...
                    <p className="text-green-500 font-thicccboibold !text-7xl">{latestBlock.confidence}%</p>
                </div>
                <div>
                    <div className="flex flex-col items-end space-y-4">
                        <div className="flex flex-col ">
                            ...
                            <p className="text-green-500 font-thicccboibold !text-3xl text-right">{latestBlock.hash}</p>
                        </div>
                        <div className="flex flex-col ">
